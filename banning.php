<?php
    ...
    $to = $email['email'];
    $subject = "Banning to post Thread in Metaforums";
    $message = "Dear Metaforums user, ";
    $message .= "We're sorry to put you in banning mode due to some of your posts for 30 minutes.";
...
$t = "UPDATE account SET status = '4', silent='$op' WHERE userid='$mdid'";
